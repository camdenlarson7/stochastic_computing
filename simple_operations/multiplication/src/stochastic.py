...
def generate_sobol_bitstream(value, num_bits, seed):
...
def stochastic_multiply(num_bits=128):
    ...
    print("number b :", b)
    x, xcount = generate_sobol_bitstream(a, num_bits, seed=123)
    y, ycount = generate_sobol_bitstream(b, num_bits, seed=567)
    result = []
...
if __name__ == "__main__":
    ...
    df.to_csv('sobol_multiplication_results.csv', index=False)
    print(df)
    # Append to master file
    master_file = 'all_sobol_results.csv'
